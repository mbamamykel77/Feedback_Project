...
<?php
  ...
  if(empty($nameErr) && empty($emaiErr) && empty($bodyErr)) {
    // add to the database
...
<img src="/feedback/img/logo.jpg" class="w-25 mb-3" alt="">
<p class="lead text-center">Leave feedback for Mykel Media</p>
